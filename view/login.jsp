         ...
         <ul class="navbar-nav ml-auto">
           ...
           <li class="nav-item dropdown active">
            ...
            <div class = "dropdown-menu">
              ...
              <a class="dropdown-item active" href="SoftwareDevelopment.jsp"> Software Development</a>
            ...
            <div class="col-12 form-input">
              ...
              <spring:bind path="username">
                <div class="form-group ${status.error? 'has error' : '' }">
                  <form:input type="text" class="form-control" placeholder ="Enter Username" path="username"></form:input>
                  <form:errors path="username"></form:errors>
                </div>
                </spring:bind>
                <spring:bind path="password ${status.error? 'has error' : '' }">
                <div class="form-group">
                  <form:input type="password" path="password" class="form-control" placeholder="Enter Password"></form:input>
                  <form:errors path="password"></form:errors>
                </div>
                </spring:bind>
                <!--how to spring bind for remember me-->
