...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="resources/templates/fontawesome-free-5.13.1-web/css/all.css">
    <link rel="stylesheet" href="templates/resources/css/style.css">
    <title>Home</title>
  </head>   
  <body>
    <header>
   ...
   <li class="nav-item">
    ...
    <section class="top pt-4 pb-5">
      <div class="container">
          <div class="row align-items-center">
             <div class="col-md-5">
               <h4>Quallity-Support-Value</h4>
               <h1>Best In Class IT Service Provider</h1>

             </div>

             <div class="col-md-7">
               <img src= "resources/images/prg.svg" alt="">
             </div>
    ...
    <script src="templates/resources/bootstrap/js/jquery-3.5.1.slim.min.js"></script>
    <script src="templates/resources/bootstrap/js/popper.min.js"></script>
